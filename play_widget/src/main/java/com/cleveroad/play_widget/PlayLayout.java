...
public class PlayLayout extends RelativeLayout implements OnShadowChangeListener {
    ...
    private static final float BIG_DIFFUSER_MIN_SHADOW_PERCENT = 0.50f;
    private static final float MEDIUM_DIFFUSER_MIN_SHADOW_PERCENT = 0.50f;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //
        dur = (TextView) this.findViewById(R.id.dur);
        current = (TextView) this.findViewById(R.id.curr);
        timeview = (LinearLayout) this.findViewById(R.id.timeview);
        //
        initListeners();
        ...
        mSmallShadowDrawable.hideShadow(true, SMALL_SHADOW_OPACITY, new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
                    fabPlayDrawable = getResources().getDrawable(R.drawable.play, null);
                } else {
                    //noinspection deprecation
                    fabPlayDrawable = getResources().getDrawable(R.drawable.play);
                }
